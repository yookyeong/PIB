...
<h2>내가 주문한 내역</h2>
	...
	<thead>
		<tr>
			<th>상품정보</th><th><a href="order1List?currentPage=${pg.currentPage}">주문일자</a></th>
			...
			<td>${order1.sumValue }</td>
				...
				<c:choose>
					<c:when test="${o_cancel eq '0'}">
						주문대기<br>
						<a href="order1Cancel?mem_id=${order1.mem_id}&o_num=${order1.o_num}">주문취소하기</a>
					</c:when>
...
<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
	<a href="order1Date?currentPage=${i}">[${i}]</a>
</c:forEach>
