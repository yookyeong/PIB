					...
					<div class="shopping__cart__table">
						...
						<div align="center">
							<input type="button" value="목록"
								onclick="location.href='productTable'"> <input
								type="button" value="수정"
								onclick="location.href='productUpdateForm?p_code=${product1.p_code}&p_size=${product1.p_size }'">
							<input type="button" value="삭제"
								onclick="location.href='productDelete?p_code=${product1.p_code}&p_size=${product1.p_size }&p_img=${product1.p_img }'">
						</div>
					</div>
				</div>
			</div>
