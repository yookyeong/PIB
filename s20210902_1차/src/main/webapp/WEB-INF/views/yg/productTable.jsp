...
<script type="text/javascript">
	...
	function checkDelete(p_code) {
		...
		alert("p_size.checked-->"+p_size);
		alert("delList.checked-->"+p_code);
		location.href="productDelete?p_code="+p_code+"&p_size="+p_size;
	}
</script>
<style>
th, td {
					...
					<div class="shopping__cart__table">
						...
						<table>
							...
							<c:forEach var="product" items="${tableProduct}">
								...
								<tr>
									<td><input type="hidden" value="${product.p_size }"
										name="p_size" id="p_size"> <input name="delList"
										id="delList" type="checkbox" value="${product.p_code}" /> <img
										src="${product.p_img}" alt="img" width="100" height="100">
									</td>

									<td><a
										href="productContent?p_code=${product.p_code} &p_size=${product.p_size}">
											${product.p_code}<br>
									</a></td>
				...
				<td>${product.cate_name}</td> --%>
						...
						<div align="right">
							<input type="button" value="등록"
								onclick="location.href='productWriteForm'"> <input
								type="button" value="삭제" onclick="javascript:checkDelete();">
