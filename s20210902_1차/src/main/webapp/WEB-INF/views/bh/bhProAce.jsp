...
<body>
  ...
  <div class="w3-dropdown-click">
    ...
    <a href="bhProA?sort=1" class="w3-bar-item w3-button" >인기순</a> 
    <a href="bhProA?sort=2" class="w3-bar-item w3-button" >최신순</a> 
    <a href="bhProA?sort=3" class="w3-bar-item w3-button" >높은 가격순</a> 
    <a href="bhProA?sort=4" class="w3-bar-item w3-button" >낮은 가격순</a>
    </div>
  </div>
...
<h2>PIB 용품</h2>
	...
	<c:if test="${pg.startPage > pg.pageBlock }">
		<a href="bhProA?currentPage=${pg.startPage-pg.pageBlock}">[이전]</a>
	</c:if>
	<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
		<a href="bhProA?currentPage=${i}">[${i}]</a>
	</c:forEach>
	<c:if test="${pg.endPage < pg.totalPage }">
		<a href="bhProA?currentPage=${pg.startPage+pg.pageBlock}">[다음]</a>
	</c:if>
</div>
