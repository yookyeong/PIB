...
<body>
  ...
  <div class="w3-dropdown-click">
    ...
    <a href="bhProS?sort=1" class="w3-bar-item w3-button" >인기순</a> 
    <a href="bhProS?sort=2" class="w3-bar-item w3-button" >최신순</a> 
    <a href="bhProS?sort=3" class="w3-bar-item w3-button" >높은 가격순</a> 
    <a href="bhProS?sort=4" class="w3-bar-item w3-button" >낮은 가격순</a>
    </div>
  </div>
