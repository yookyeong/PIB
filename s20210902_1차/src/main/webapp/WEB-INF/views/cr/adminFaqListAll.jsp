...
<body>
    ...
    <section>
    	<div class="container">
    	<div>
    		<span><a href="adminFaqListAll">전체</a></span>
    		<span><a href="adminFaqListAll?q_mcode=310">제품</a></span>
    		<span><a href="adminFaqListAll?q_mcode=320">배송</a></span>
    		<span><a href="adminFaqListAll?q_mcode=330">교환/환불</a></span>
    		<span><a href="adminFaqListAll?q_mcode=340">주문결제</a></span>
    		<span><a href="adminFaqListAll?q_mcode=350">기타</a></span>
    	</div>
    	...
    	<div>
			...
			<c:forEach var="i" begin="${page.startPage }" end="${page.endPage }">
				<a href="adminFaqListAll?q_mcode=${faq.q_mcode }&currentPage=${i }">[${i }]</a>
			</c:forEach>
    	...
    	<div>
    		<button type="button" onclick="location.href='faqWriteForm'">글작성</button>
    	</div>
    	</div>
    </section>
