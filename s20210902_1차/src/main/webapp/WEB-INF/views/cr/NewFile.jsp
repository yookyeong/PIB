...
<body>
  ...
  <div>
    ...
    <section>
    	<div class="container">
    	<div>
    		<span><a href="faqListAll">전체</a></span>
    		<span><a href="faqListAll?q_mcode=310">제품</a></span>
    		<span><a href="faqListAll?q_mcode=320">배송</a></span>
    		<span><a href="faqListAll?q_mcode=330">교환/환불</a></span>
    		<span><a href="faqListAll?q_mcode=340">주문결제</a></span>
    		<span><a href="faqListAll?q_mcode=350">기타</a></span>
    	</div>
    	<div class="shopping__cart__table">
    		<ul style="list-style: none;">
    			...
    			<li id="faqListId${cnt}" class="faqHide" style="border-top: 1px solid gray;">
    				...
    				<div class="title" onclick="faqList(${cnt})" style="padding: 30px;">
							<span class="cate" style="padding-right: 30px;">${faq.content }&nbsp;&nbsp;-&nbsp;&nbsp; </span>
							<span class="title">${faq.f_title }</span>
					</div>
					<div class="content${cnt }" style="display: none; padding :30px; background-color: rgb(238,238,238);">
