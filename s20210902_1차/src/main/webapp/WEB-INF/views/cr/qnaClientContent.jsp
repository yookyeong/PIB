...
<body>
    ...
    <section>
		...
		<form action="qnaWritePro" method="post" enctype="multipart/form-data" target="myBatisFrame">
			...
			<div>
			<c:if test="${qna.q_reply == null}">
				<textarea rows="5" cols="100" readonly="readonly">답변대기 중 입니다.</textarea>
			</c:if>
			<c:if test="${qna.q_reply != null}">
				<pre><textarea rows="5" cols="100" readonly="readonly">${qna.q_reply }</textarea></pre>
			</c:if>
			</div>
