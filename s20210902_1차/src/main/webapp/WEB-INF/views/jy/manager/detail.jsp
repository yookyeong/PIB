...
<form id="detailDelite">
	...
	<table>
		...
		<tr>
			<td colspan="2">
			<input type="button" value="목록" 	onclick="location.href='<%=context%>/mng/list'"> 
			<input type="button" value="수정" onclick="location.href='<%=context%>/mng/update?mem_no=${member.mem_no}'">
