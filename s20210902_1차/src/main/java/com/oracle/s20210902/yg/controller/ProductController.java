...
public class ProductController {
	...
	public String ProductTable(Product product, String currentPage, Model model) {
	...
	public String productWrite(HttpServletRequest request, MultipartFile file1,  Product product, Model model) 
		...
		return "redirect:productWriteForm";
	}
	...
	public String productUpdate(Product product, Model model) {
		...
		int a = ps.productUpdate(product);
		System.out.println("ps.productUpdate a->" + a);
